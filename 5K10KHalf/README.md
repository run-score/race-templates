...
1. Set gun time(s) -- `GunTimePromt5K.2.O.lst` / `GunTimePromt10K.2.O.lst` / `GunTimePromtHalf.2.O.lst` or `@GUNTIME.2.O.lst`.
...
6. Print / upload awards -- `@awards5K.6.R.lst` / `@awards10K.6.R.lst` / `@awardsHalf.6.R.lst` and matching `@awards2RR*` listings.
...
- Awards filenames use uppercase K: `@awards5K`, `@awards10K`, `@awardsHalf`
- Filename typo retained: `GunTimePromt` (not Prompt)
- Distance-specific LPT RSMs exist for 10K and Half course splits
